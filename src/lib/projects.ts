...
export const projects: Project[] = [
  {
    ...
    blurb: "Getting Things Done as a TUI, CLI, and API: capture, triage, review.",
  ...
  },
  {
    ...
    blurb: "Reusable Claude Code skills, packaged as one installable plugin.",
  ...
  },
  {
    name: "git-a-grip",
    description:
      "Take control of your Git history with this curated list of hooks plus a CLI for local pre-commit management",
